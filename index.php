...
<body style="font-size: 1.3rem !important;">
                            ...
                            <div class="chat-input-links ml-md-2">
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <button type="submit" id="conversation-send-button" class="btn btn-info font-size-16 btn-lg chat-send waves-effect waves-light" style='background-color:#13abee;'>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("body").on('click','.chatuser', function(){
            ...
            chatCompany = $(this).data('company');
            receiver = $(this).data('receiver');
            // console.log(receiver);
            $("#active-receiver").val(receiver);
            $("#activeChatName").html(chatName + '<br><small>' + chatCompany +'</small>');
    ...
    function scrollTextUp(chat, chatConversation){
        ...
        if(chatHeight !== chat.prop("scrollHeight")){
            ...
            chat.animate({ scrollTop: chatHeight }, "fast");
        }
    }

    function searchUsers(){
        // target_id = '#r' + receiver;
        $(".chat-user-list").html("<h3>Searching...</h3>");
        $.ajax({
            type: "GET",
            url: "ajax.php/",
            data: {
