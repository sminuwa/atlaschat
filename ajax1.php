...
<!--              <span class="user-status"></span>-->
            ...
            <div class="media-body overflow-hidden">
              ...
              <p class="chat-user-message text-truncate mb-0" style="color:#dedbfd;">Company ~
...
//        $search = $request->search;
    $users = DataManager::query("users",'*',"((Role = '$userRole' AND CompanyName = '$userCompany') OR (Role != '$userRole')) AND FirstName like '%$search%' AND id != $userId");
...
<!--                <span class="user-status"></span>-->
            ...
            <div class="media-body overflow-hidden">
                ...
                <p class="chat-user-message text-truncate mb-0"  style="color:#dedbfd;">Company ~<i> <?php echo  $user->CompanyName ;?></i></p>
            </div>
...
if($_REQUEST['type'] == "send") {
    $user = DataManager::query('usersZ','*',"id=$sender")[0];
//    $sender = $user->id;
